...
using PermissionRequest.Infraestructure.Repositories;
using PermissionRequest.Infraestructure.Repositories.Interfaces;

namespace PermissionRequest.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IPermissionsRepository<>), typeof(PermissionRepository<>));
            services.AddTransient<IPermissionsServices, PermissionsServices>();
            services.AddTransient<IPermissionsTypeServices, PermissionsTypeService>();
        }
